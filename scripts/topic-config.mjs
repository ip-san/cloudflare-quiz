...
export const DOC_PAGES = [
  ...
  { name: 'cache' },
  { name: 'cache/concepts/default-cache-behavior' },
  { name: 'cache/how-to/cache-rules' },
  { name: 'cache/how-to/cache-rules/settings' },
  { name: 'cache/how-to/cache-rules/order' },
  { name: 'cache/how-to/cache-rules/page-rules-migration' },
  { name: 'cache/how-to/cache-keys' },
  { name: 'cache/how-to/edge-browser-cache-ttl' },
  { name: 'cache/how-to/tiered-cache' },
  { name: 'cache/advanced-configuration/cache-reserve' },
  { name: 'cache/how-to/set-caching-levels' },
  { name: 'cache/concepts/cache-responses' },
  { name: 'rules' },
  { name: 'rules/transform' },
  { name: 'rules/transform/url-rewrite' },
  { name: 'rules/transform/request-header-modification' },
  ...
  { name: 'rules/configuration-rules' },
  { name: 'rules/configuration-rules/settings' },
  { name: 'rules/snippets' },
  { name: 'rules/snippets/when-to-use' },
  { name: 'dns' },
  { name: 'dns/proxy-status' },
  { name: 'dns/manage-dns-records' },
  { name: 'dns/manage-dns-records/reference/dns-record-types' },
  { name: 'dns/manage-dns-records/reference/ttl' },
  { name: 'dns/dnssec' },
  { name: 'dns/zone-setups' },
  { name: 'dns/zone-setups/full-setup' },
  { name: 'dns/zone-setups/partial-setup' },
  { name: 'dns/cname-flattening' },
  { name: 'dns/zone-setups/zone-transfers' },
  { name: 'ssl' },
  { name: 'ssl/origin-configuration/ssl-modes' },
  { name: 'ssl/origin-configuration/ssl-modes/flexible' },
  { name: 'ssl/origin-configuration/ssl-modes/full' },
  ...
  { name: 'ssl/edge-certificates/additional-options/minimum-tls' },
  { name: 'ssl/edge-certificates/additional-options/always-use-https' },
  { name: 'ssl/edge-certificates/additional-options/automatic-https-rewrites' },
  { name: 'ssl/reference/certificate-validity-periods' },
  { name: 'speed' },
  ...
  { name: 'cache/advanced-configuration/early-hints' },
  { name: 'speed/optimization/content/troubleshooting/disable-auto-minify' },
  { name: 'speed/optimization/protocol/http2' },
  { name: 'speed/optimization/protocol/http3' },
  ...
  { name: 'client-side-security/get-started' },
  { name: 'client-side-security/how-it-works' },
  { name: 'client-side-security/how-it-works/malicious-script-detection' },
  { name: 'client-side-security/detection/monitor-connections-scripts' },
  { name: 'client-side-security/detection/review-changed-scripts' },
  { name: 'client-side-security/detection/review-malicious-scripts' },
  { name: 'client-side-security/rules' },
  { name: 'client-side-security/rules/csp-directives' },
  { name: 'client-side-security/rules/violations' },
  { name: 'client-side-security/reference/csp-header' },
  { name: 'client-side-security/reference/pci-dss' },
  { name: 'client-side-security/reference/script-statuses' },
  ...
  { name: 'cloudflare-one/data-loss-prevention' },
  { name: 'cloudflare-one/data-loss-prevention/detection-entries' },
  { name: 'cloudflare-one/data-loss-prevention/detection-entries/predefined-detection-entries' },
  { name: 'cloudflare-one/data-loss-prevention/detection-entries/configure-detection-entries' },
  { name: 'cloudflare-one/data-loss-prevention/dlp-policies' },
  { name: 'cloudflare-one/data-loss-prevention/dlp-policies/common-policies' },
  { name: 'cloudflare-one/data-loss-prevention/dlp-policies/logging-options' },
  { name: 'cloudflare-one/data-loss-prevention/dlp-profiles' },
  { name: 'cloudflare-one/data-loss-prevention/dlp-profiles/predefined-profiles' },
  { name: 'cloudflare-one/data-loss-prevention/dlp-profiles/integration-profiles' },
  { name: 'cloudflare-one/data-loss-prevention/dlp-profiles/advanced-settings' },
  { name: 'cloudflare-one/data-loss-prevention/data-classification' },
  ...
  { name: 'cloudflare-one/remote-browser-isolation/extensions' },
  { name: 'cloudflare-one/remote-browser-isolation/known-limitations' },
  { name: 'cloudflare-one/remote-browser-isolation/network-dependencies' },
  { name: 'cloudflare-one/remote-browser-isolation/accessibility' },
  { name: 'cloudflare-one/remote-browser-isolation/setup' },
  { name: 'cloudflare-one/remote-browser-isolation/setup/clientless-browser-isolation' },
  { name: 'cloudflare-one/remote-browser-isolation/setup/non-identity' },
  { name: 'cloudflare-one/cloud-and-saas-findings' },
  { name: 'cloudflare-one/cloud-and-saas-findings/casb-dlp' },
  { name: 'cloudflare-one/cloud-and-saas-findings/manage-findings' },
  { name: 'cloudflare-one/cloud-and-saas-findings/troubleshoot-casb' },
  { name: 'cloudflare-one/integrations/cloud-and-saas' },
  { name: 'cloudflare-one/integrations/cloud-and-saas/webhooks' },
  { name: 'cloudflare-one/cloud-and-saas-findings/policies' },
  ...
  { name: 'waiting-room' },
  { name: 'waiting-room/about' },
  { name: 'waiting-room/get-started' },
  { name: 'waiting-room/how-to/create-waiting-room' },
  { name: 'waiting-room/how-to/control-user-session' },
  { name: 'waiting-room/how-to/customize-waiting-room' },
  { name: 'waiting-room/how-to/json-response' },
  { name: 'waiting-room/additional-options/create-events' },
  { name: 'waiting-room/reference/queueing-methods' },
  { name: 'waiting-room/reference/configuration-settings' },
  { name: 'waiting-room/reference/waiting-room-cookie' },
  { name: 'waiting-room/plans' },
  { name: 'zaraz' },
  { name: 'zaraz/get-started' },
  { name: 'zaraz/reference/triggers' },
  { name: 'zaraz/reference/supported-tools' },
  { name: 'zaraz/reference/settings' },
  { name: 'zaraz/custom-actions/create-action' },
  { name: 'zaraz/custom-actions/create-trigger' },
  { name: 'zaraz/consent-management' },
  { name: 'zaraz/advanced/datalayer-compatibility' },
  { name: 'zaraz/advanced/context-enricher' },
  { name: 'zaraz/web-api/track' },
  { name: 'zaraz/web-api/debug-mode' },
  { name: 'zaraz/history/preview-mode' },
  { name: 'zaraz/monitoring' },
  { name: 'zaraz/pricing-info' },
  { name: 'r2' },
