...
export const ja: LocaleConfig = {
  ...
  freeTier: {
    title: '無料枠早見表',
    subtitle: '無料でどこまで行けるかを1画面で',
    intro:
      '個人開発で最初に不安になるのは「これ、いくらかかるんだろう」です。主要サービスの無料枠をまとめました。この範囲に収まっているうちは、サーバー代を気にせず作り続けられます。',
    officialDocs: '公式ドキュメントで確認',
    disclaimer:
      '※ 数値は公式ドキュメントからの転記です（機械照合で追従を検証しています）。料金・上限は変更されることがあるため、重要な判断の前には必ず公式ドキュメントで最新の値を確認してください。',
  },
