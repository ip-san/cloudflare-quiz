...
const VALID_DOC_PAGES = [
  ...
  'd1/get-started/',
  'd1/platform/limits/',
  'd1/reference/community-projects/',
  'd1/reference/migrations/',
  'd1/reference/time-travel/',
  'd1/sql-api/foreign-keys/',
  ...
  'durable-objects/api/sqlite-storage-api/',
  'durable-objects/api/stub/',
  ...
  'rules/',
  'rules/transform/',
  'rules/transform/url-rewrite/',
  'rules/transform/request-header-modification/',
  ...
  'cloudflare-one/data-loss-prevention/passive-detection/',
  'ai-gateway/features/dlp/',
  'ai-gateway/features/dlp/set-up-dlp/',
  'cloudflare-one/remote-browser-isolation/',
  'cloudflare-one/remote-browser-isolation/isolation-policies/',
  'cloudflare-one/remote-browser-isolation/canvas-remoting/',
  'cloudflare-one/remote-browser-isolation/extensions/',
  'cloudflare-one/remote-browser-isolation/known-limitations/',
  'cloudflare-one/remote-browser-isolation/network-dependencies/',
  'cloudflare-one/remote-browser-isolation/accessibility/',
  ...
  'cloudflare-one/cloud-and-saas-findings/policies/',
  ...
  'r2/buckets/object-lifecycles/',
  'r2/buckets/public-buckets/',
  'r2/buckets/storage-classes/',
  'r2/data-migration/super-slurper/',
  'r2/objects/upload-objects/',
  'r2/pricing/',
  'r2/reference/wrangler-commands/',
  'vectorize/',
  'vectorize/best-practices/create-indexes/',
  'vectorize/best-practices/insert-vectors/',
  'vectorize/platform/limits/',
  ...
  'workers-ai/models/',
  'workers/',
  'workers/configuration/compatibility-dates/',
  ...
  'workers/observability/logs/tail-workers/',
  ...
  'workers/runtime-apis/html-rewriter/',
  'workers/runtime-apis/nodejs/',
  'workers/runtime-apis/request/',
  'workers/runtime-apis/streams/',
